  ...
  return (
    <section className="relative w-full min-h-[600px] h-[85vh] md:h-screen flex items-center justify-center overflow-hidden my-6">
      ...
      <div className="absolute top-[10%] left-[5%] md:left-[12%] opacity-80 animate-float z-10 hidden sm:block" style={{ animationDelay: '0s' }}>
        <Image src="/images/home/elevate/floating_cap.png" width={140} height={140} alt="Floating Cap" style={{ width: 'auto', height: 'auto' }} className="w-24 sm:w-36 md:w-44 h-auto rotate-[-15deg] drop-shadow-2xl" />
      </div>
      <div className="absolute top-[12%] right-[5%] md:right-[12%] opacity-80 animate-float z-10 hidden sm:block" style={{ animationDelay: '1s' }}>
        <Image src="/images/home/elevate/floating_tshirt.png" width={180} height={180} alt="Floating T-shirt" style={{ width: 'auto', height: 'auto' }} className="w-28 sm:w-40 md:w-52 h-auto rotate-[10deg] drop-shadow-2xl" />
      </div>
      <div className="absolute bottom-[10%] left-[8%] md:left-[15%] opacity-80 animate-float z-10 hidden sm:block" style={{ animationDelay: '2s' }}>
        <Image src="/images/home/elevate/floating_jacket.png" width={200} height={200} alt="Floating Jacket" style={{ width: 'auto', height: 'auto' }} className="w-32 sm:w-44 md:w-56 h-auto rotate-[5deg] drop-shadow-2xl" />
      </div>
      <div className="absolute bottom-[12%] right-[8%] md:right-[15%] opacity-80 animate-float z-10 hidden sm:block" style={{ animationDelay: '1.5s' }}>
        <Image src="/images/home/elevate/floating_sneaker.png" width={160} height={160} alt="Floating Sneaker" style={{ width: 'auto', height: 'auto' }} className="w-28 sm:w-36 md:w-48 h-auto rotate-[-10deg] drop-shadow-2xl" />
      </div>

      {/* Main Model Image Overlay */}
      <Image 
        src="/images/home/elevate/elevate_main.png" 
        width={600} 
        height={500} 
